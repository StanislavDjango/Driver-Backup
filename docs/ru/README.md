...
GitHub Actions автоматически собирает EXE при каждом push и pull request. Когда отправляется тег версии вроде `v0.3.0`, workflow также создает или обновляет GitHub Release и загружает:
