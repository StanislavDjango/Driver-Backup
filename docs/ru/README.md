...
GitHub Actions автоматически собирает EXE при каждом push и pull request. Когда отправляется тег версии вроде `v0.3.2`, workflow также создает или обновляет GitHub Release и загружает:
