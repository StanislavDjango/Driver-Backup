...
GitHub Actions автоматически собирает EXE при каждом push и pull request. Когда отправляется тег версии вроде `v0.2.0`, workflow также создает или обновляет GitHub Release и загружает:
